...
const BlackButton = (props: BlackButtonProps) => {
  return (
    <button
      ...
      className={`w-full cursor-pointer rounded-md bg-black py-2 px-4 border border-transparent text-center text-sm text-white transition-all shadow-md hover:shadow-lg focus:bg-gray-100 focus:text-black focus:shadow-none active:bg-gray-100 hover:bg-gray-100 hover:text-black active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none`}
    >
      {props.text}
    </button>
  );
