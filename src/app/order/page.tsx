...
export default function OrderPage() {
  ...
  const handlePaymentModalOpen = () => {
    ...
    if (addressError) {
      openAlert({
        title: "안내",
        message: "배송지 정보에 오류가 있습니다. 배송지를 다시 확인해주세요.",
        type: "error",
      });
      return;
    }
                ...
                <CardContent className="p-6">
                  ...
                  {selectedAddress && (
                    <div className="mt-4">
                      <Select
                        defaultValue={
                          selectedAddress.deliverRequest || "default"
                        }
                      >
                        <SelectTrigger
